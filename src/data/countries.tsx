...
export type CountriesOption = { id: string; name: string };
export const CountriesRelation: CountriesOption[] = [
  { id: '', name: 'Default' },
...
export const Countries: { [id: number]: CountryDataType } = {
  [eCountry.UK]: {
    Flag: <Flags.GB title="United Kingdom" className="flag" />,
    CurrencySymbol: '\u00A3',
    TopLevelDomain: 'co.uk'
  },
  [eCountry.US]: {
    Flag: <Flags.US title="United States" className="flag" />,
    CurrencySymbol: '\u0024',
    TopLevelDomain: 'com'
  },
  [eCountry.DE]: {
    Flag: <Flags.DE title="Germany" className="flag" />,
    CurrencySymbol: EURSymbol,
    TopLevelDomain: 'de'
  },
  [eCountry.ES]: {
    Flag: <Flags.ES title="Spain" className="flag" />,
    CurrencySymbol: EURSymbol,
    TopLevelDomain: 'es'
  },
  [eCountry.FR]: {
    Flag: <Flags.FR title="France" className="flag" />,
    CurrencySymbol: EURSymbol,
    TopLevelDomain: 'fr'
  },
  [eCountry.AU]: {
    Flag: <Flags.AU title="Australia" className="flag" />,
    CurrencySymbol: 'AUD',
    TopLevelDomain: 'com.au'
  },
  [eCountry.IT]: {
    Flag: <Flags.IT title="Italy" className="flag" />,
    CurrencySymbol: EURSymbol,
    TopLevelDomain: 'it'
  }
};