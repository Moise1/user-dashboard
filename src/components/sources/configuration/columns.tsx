...
export type ColumnChannelAncestor = { Field: SettingKey, Value: string }
...
export interface Column {
  ...
  Channels?: ePlatform[];
  Style?: ColumnStyle;
  ChannelSetting?: SettingKey;//In case value is undefined, it will use this channelsetting as default value to show it
...
export const Columns: Column[] = [
  ...
  },
  {
    ...
    ChannelSettingAncestors: [{ Field: SettingKey.UseBusinessPolicies, Value: '0' }],
  ...
  },
  {
    ...
    Channels: [ePlatform.eBay, ePlatform.eBayNoApi],
    ChannelSettingAncestors: [{ Field: SettingKey.UseBusinessPolicies, Value: '1' }],
