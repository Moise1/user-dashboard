      ...
      <Sider theme="light" className="h-100 border-right border z-10" trigger={null} collapsible collapsed={collapsed}>
        ...
        <div className="d-flex flex-column justify-content-between h-100">
          <Menu theme="light" mode="inline" defaultSelectedKeys={['4']}>
            <Menu.Item key="0" icon={<img src={logo} className="d-none" height={30} alt="" />}>
            ...
            <Menu.Item
              ...
              icon={<img className="active-white-svg" src={dashboard} height={20} alt="" />}
            >
              {t('ds')}
            </Menu.Item>
            <Menu.Item
              style={{ color: '#000', fontSize: '18px', fontWeight: 'bold' }}
              key="2"
              icon={<img className="active-white-svg" src={catalog} height={20} alt="" />}
            >
            ...
            <Menu.Item
              style={{ color: '#000', fontSize: '18px', fontWeight: 'bold' }}
              key="3"
              icon={<img className="active-white-svg" src={listnow} height={20} alt="" />}
            >
              {t('ln')}
            </Menu.Item>
            <Menu.Item
              key="4"
              style={{ color: '#000', fontSize: '18px', fontWeight: 'bold' }}
              icon={<i onClick={routeChange} className="fas active-white-svg fa-list d-blue"></i>}
            >
              <button className="bg-trans fw-700  border-0" onClick={() => history.push('/home')}>
                {t('ls')}
              </button>
            </Menu.Item>
            <SubMenu
              key="sub3"
              style={{ color: '#000', fontSize: '18px', fontWeight: 'bold' }}
              icon={<img className="active-white-svg" src={settings} height={20} alt="" />}
              title="Settings"
            >
          ...
          {t("set")} <i className="fas fa-sort-down text-dark ml-2"></i>
            ...
            <SubMenu
              key="sub4"
              style={{ color: '#000', fontSize: '18px', fontWeight: 'bold' }}
              icon={<img className="active-white-svg" src={services} height={20} alt="" />}
              title="Services"
            >
              {/* {t("set")} <i className="fas fa-sort-down text-dark ml-2"></i> */}
        ...
        >
          {t("srvc")} <i className="fas fa-sort-down text-dark ml-2"></i>
            ...
            <SubMenu
              key="sub5"
              style={{ color: '#000', fontSize: '18px', fontWeight: 'bold' }}
              icon={<img className="active-white-svg" src={help} height={20} alt="" />}
              title="Help"
            >
              {/* {t("set")} <i className="fas fa-sort-down text-dark ml-2"></i> */}
              <Menu.Item key="18">
