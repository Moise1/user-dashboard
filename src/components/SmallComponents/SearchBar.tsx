  ...
  return (
    <div className="row justify-content-between pl-3 py-lg-3 mt-md-3 mt-lg-1">
      <div className="col-md-7 pl-lg-0 lh-1 px-0">
        <div className="input-group br-10 input-group-sm border  rounded pr-1 bg-white">
          <input
            type="text"
      ...
      <div className="col-md-5   my-md-0 lh-1  d-md-block d-none">
        <div className="d-flex w-100 justify-content-end ">
          <button className="btn  fs-18 fw-bold bg-c4c4c4  p-3  text-white border-0 br-8">
            <img
              src={list_saerch}
          ...
          <button className="btn  ml-3 my-auto p-3  fs-18 fw-bold bg-purple text-white border-0 br-8">
