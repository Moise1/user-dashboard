  ...
  return (
    <>
      <Row className="description-and-controls">
        <Col md={24} lg={12} className="description-area">
          <h4>Markup %</h4>
          <p>
        ...
        <Col md={24} lg={8} className="input-container">
          <Input value="30" className="blue-input" />
        </Col>
      </Row>

      <Row className="description-and-controls">
        <Col md={24} lg={8} className="description-area">
          <h4>Monitor stock</h4>
          <p>
        ...
        <Col md={24} lg={8} className="switch-container">
          <Switch />
        </Col>
      </Row>
      ...
      <Row className="description-and-controls">
        ...
        <Col md={24} lg={8} className="limit-section">
      ...
      <Row className="description-and-controls">
        <Col md={24} lg={8} className="description-area" span={12}>
          <h4>Min. Quantity</h4>
      ...
      <Row className="description-and-controls">
        ...
        <Col md={24} lg={8} className="stock-container">
