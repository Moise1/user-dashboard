...
export const createRule = createAsyncThunk('rules/createRule', async (data: PriceRule, thunkAPI) => {
  try {
...
export const updateRule = createAsyncThunk(
  'rules/updateRule',
  async ({ id: ruleId, active }: { id: PriceRule['id']; active: PriceRule['active'] }, thunkAPI) => {
    try {
