...
export const SettingNumber = (props: Props) => {
  ...
  let input =  <div className="setting setting-number">
    <Input defaultValue={defaultValue ?? ''} type='number' className='blue-input' onChange={OnChange} disabled={loading || disabled} value={value ?? superiorValue} placeholder={placeholder} />
    {loading && <Spin />}
  </div>;
